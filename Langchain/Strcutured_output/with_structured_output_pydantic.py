...
class Review(BaseModel):
    key_themes : list[str] = Field(description="write down the key topics discussed in the review in a list")
    summary : str = Field(description="A short and brief summary of the review")
    sentiment : Literal['pos','neg'] = Field(description="Return the sentiment of the overall review")
    pros : Optional[list[str]] = Field(default=None, description="Return the pros discussed in the review")
    cons : Optional[list[str]] = Field(default=None, description="Return the cons discussed in the review")
...
recently upgraded to the Samsung Galaxy S24 Ultra, and I must say, it's an absolute powerhouse! The Snapdragon 8 Gen 3
