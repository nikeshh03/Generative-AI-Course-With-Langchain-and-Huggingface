...
class Review(TypedDict):
    key_themes : Annotated[list[str], "write down the key topics discussed in the review in a list"]
    summary : Annotated[str, "A short and brief summary of the review"]
    sentiment : Annotated[Literal["Pos","neg"],"Return the sentiment of the overall review"]
    pros : Annotated[Optional[list[str]], "Return the pros discussed in the review"]
    cons : Annotated[Optional[list[str]], "Return the cons discussed in the review"]
